...
require('@vaadin/vaadin-grid/src/vaadin-grid.js');
require('@polymer/iron-ajax');
require('@polymer/polymer/lib/elements/dom-bind.js');
...
class WhcgLitGrid extends polymerElement_js.PolymerElement {
    static get template() {
...
exports.WhcgLitGrid = WhcgLitGrid;
